    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Link href="/admin/projects" className="bg-surface p-6 rounded-xl border border-border shadow-sm hover:border-primary/30 transition-all group">
          ...
          <div className="text-3xl font-bold text-primary group-hover:scale-110 transition-transform origin-left">12</div>
        ...
        <Link href="/admin/leads" className="bg-surface p-6 rounded-xl border border-border shadow-sm hover:border-yellow-500/30 transition-all group">
          ...
          <div className="text-3xl font-bold text-yellow-600 group-hover:scale-110 transition-transform origin-left">5</div>
        ...
        <div className="bg-surface p-6 rounded-xl border border-border shadow-sm">
          ...
          <div className="mt-4 text-[10px] font-bold text-foreground/30 uppercase tracking-widest">Data Simulasi</div>
        </div>
      </div>
    </div>
  );
