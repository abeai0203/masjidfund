          ...
          <section className="bg-surface rounded-2xl p-6 sm:p-8 border border-border shadow-sm">
            ...
            <div className="mt-8 bg-surface-muted rounded-xl p-5 border border-border">
              ...
              <p className="text-sm text-foreground/70 mb-3 leading-relaxed">
                Kempen ini telah disemak oleh platform. Butiran projek telah disahkan sama dengan paparan iklan berkenaan. Jika ada sebarang khilaf/keraguan boleh <Link href={`/feedback?project_id=${project.id}&project_name=${encodeURIComponent(project.title)}`} className="text-primary hover:underline font-bold">Hubungi Kami</Link> kepada kami.
              </p>
