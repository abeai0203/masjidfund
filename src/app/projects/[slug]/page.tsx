...
function shareToWhatsApp(project: Project) {
  const url = typeof window !== "undefined" ? window.location.href : `https://masjidfund.pages.dev/projects/${project.slug}`;
          ...
          <section className="bg-surface rounded-2xl p-6 sm:p-8 border border-border shadow-sm">
            ...
            <div className="mt-8 bg-surface-muted rounded-xl p-5 border border-border">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <Link href="/about/trust" className="text-sm text-primary hover:text-primary-hover font-bold hover:underline transition-all">
              ...
              {project.collected_amount >= project.target_amount ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full mt-3 flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold py-3 px-4 rounded-xl transition-all shadow-sm"
                  >
