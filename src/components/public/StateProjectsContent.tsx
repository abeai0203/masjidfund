...
export default function StateProjectsContent() {
  const params = useParams();
  const stateParam = typeof params?.state === 'string' ? decodeURIComponent(params.state) : "";
  ...
  if (!stateParam) {
     return (
        <div className="flex items-center justify-center h-64">
           <p className="text-slate-500">Negeri tidak sah.</p>
        </div>
     );
  }
    ...
    <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 w-full flex-grow flex flex-col">
      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className="bg-slate-50 border border-border rounded-xl flex flex-col items-center justify-center p-12 text-center h-64">
